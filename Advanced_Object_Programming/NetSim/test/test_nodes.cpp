...
TEST(WorkerTest, HasBuffer) {     // Test nie przeszedł
...
TEST(RampTest, IsDeliveryOnTime) { // Przeszedł test
...
TEST(ReceiverPreferencesTest, AddReceiversRescalesProbability) {        // Test przeszedł
...
TEST(ReceiverPreferencesTest, RemoveReceiversRescalesProbability) {     // Test przeszedł
...
TEST_F(ReceiverPreferencesChoosingTest, ChooseReceiver) {           // Nie działa
...
TEST(PackageSenderTest, SendPackage) {        // Działa!!!!
